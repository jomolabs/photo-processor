...
CREATE UNIQUE INDEX photo_thumbnails__photo_uuid__width__height_uniq ON photo_thumbnails (photo_uuid, width, height);
ALTER TABLE photo_thumbnails
ADD CONSTRAINT photo_thumbnails__photo_uuid__width__height_uniq
UNIQUE USING INDEX photo_thumbnails__photo_uuid__width__height_uniq;
